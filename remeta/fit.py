...
try:
    ...
    from remeta_v1.remeta.util import TAB
    from remeta_v1.remeta.util import _slsqp_epsilon
...
def fmincon(fun, param_set, args, gridsearch=False, grid_multiproc=True,
    ...
    if fine_gridsearch:
        x0 = fine_grid_search(x0, fun, args, param_set, ll_grid, valid, n_grid_candidates, n_grid_iter,  # noqa
